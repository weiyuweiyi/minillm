...
class PPOSampler():
    ...
    def run_sample(self, num_rollouts_per_device: int = 1024, iter_count: int = 0):
        ...
        """
        #采样模型并且计算kl在相对于一个参考模型
        ppo_rl_elements = []

        while len(ppo_rl_elements) < num_rollouts_per_device:#每个设备多少数据
