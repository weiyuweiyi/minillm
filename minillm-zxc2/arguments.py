...
def add_model_args(parser: argparse.ArgumentParser):
    ...
    # 教师模型类型参数，允许传递多个教师
    group.add_argument("--teacher-model-type", type=str, action="append", default=None)
    group.add_argument("--teacher-model-path", type=str, action="append")
